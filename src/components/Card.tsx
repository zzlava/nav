    ...
    <div className="group relative overflow-hidden rounded-lg border bg-background p-2">
      <div className="aspect-video overflow-hidden rounded-md">
        {imageUrl ? (
          ...
          <div className="flex h-full items-center justify-center bg-muted">
            <svg className="h-8 w-8 sm:h-10 sm:w-10 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {onDelete && (
        <button
          ...
          className="absolute right-2 top-2 rounded-md bg-background/80 p-2 opacity-0 backdrop-blur transition-opacity hover:bg-background group-hover:opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
          aria-label="删除"
        >
